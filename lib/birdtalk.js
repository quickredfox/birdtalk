(function() {
  ...
  */
  ...
  export_template = "<!DOCTYPE html> <html lang=\"en\">    <head>        <meta charset=\"utf-8\">        <title>            {title}        </title>        <link rel=\"stylesheet\" href=\"http://assets.needium.com/lib/bootstrap/1.4.0/bootstrap.css\" type=\"text/css\">        <style type=\"text/css\" media=\"all\">            .tweet{padding-top:0.5em;padding-bottom:0.5em;}            .tweet:nth-of-type(2n){background:#f0f0f0}            time{color:#999;padding-right:1em}            .tweet p{font-size:1.25em;padding:0.5em 0em}        </style>        <style type=\"text/css\" media=\"print\">            .tweet{border-bottom:1px dotted #999;}        </style>    </head>    <body>        <div class=\"container\">        {title_markup}        {tweets_markup}        {note_markup}        </div>    </body></html>";
